...
@Service
public class InternationalPeriodicPaymentConsentService {

	private static final Logger LOGGER = LoggerFactory.getLogger(InternationalPeriodicPaymentConsentService.class);
	...
	public PostInternationalPaymentConstentResponse addInternationalPeriodicPaymentConsent(
		...
		LOGGER.debug("Inside InternationalPeriodicPaymentConsentService addInternationalPeriodicPaymentConsent");
		ConsentModel consentModel = new ConsentModel();
		consentModel.setName("International Periodic Payment Consent");
		consentModel.setTransactionType(Constants.TRANSACTION_TYPE_PERIODIC);
	...
	public GetInternationalPaymentConstentByIdResponse getInternationalPeriodicPaymentConstentById(Long id,String lang) {
		...
		LOGGER.debug("Inside InternationalPeriodicPaymentConsentService getInternationalPeriodicPaymentConstentById");
